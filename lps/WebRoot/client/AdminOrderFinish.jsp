...
<body>
	...
	<div class="buttom">
		<div style="position:relative;left:15px; top:10px;font-size:16px;margin:0 0 20px 0;">
			...
			>服务中</a>
			<a href="AdminOrderPaying.jsp?idAdmin=<%= idUser %>"
			>待支付</a>
			<a href="AdminOrderFinish.jsp?idAdmin=<%= idUser %>"
			style="color:blue;background:#CDC9C9;border-radius: 5px;" >已完成</a>
		...
		<div class="list" style="background:#F2F2F2;border-radius:15px;">
			<div class="item">
				<a href="AdminOrderRealPay.jsp?idAdmin=<%= idUser %>&idOrder=<%= s.getIdOrder() %>">
					...
					<p
						...
						<span style="color:red; float: left;"><%= s.getStatus() %></span>
