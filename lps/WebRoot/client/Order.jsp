...
<body>
	...
	<div class="wrap-li">
	<ul>
		<li><a href="OrderSend.jsp?idUser=<%= idUser %>" style="border: 1px; font-size: 20px;">发起订单</a></li>
		<li><a href="OrderMine.jsp?idUser=<%= idUser %>" style="border: 1px; font-size: 20px;">我的所有订单</a></li>
	...
	<footer>
		...
		</a> <a href="Message.jsp?idUser=<%=idUser%>"><i class="iconfont">&#xe75f;<img id="msg" src="image/redpoint.png" ></img></i>消息</a>
