...
<%
	...
	List<ServerOrder> lists = ServerOrderService.getInstance().getUserOrderByStatus(new User(idUser), 3, null);
%>
	...
	<div class="buttom">
		<div
			...
			<a href="Message.jsp?idUser=<%=idUser%>">待接收</a> <a
				...
				style="color:blue;background:#CDC9C9;border-radius: 5px;">待支付</a> <a
				href="MessageOrderFinish.jsp?idUser=<%=idUser%>">已完成</a> <a
