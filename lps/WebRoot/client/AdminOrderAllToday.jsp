...
<%
	...
	List<ServerOrder> lists = ServerOrderService.getInstance().getTodayOrder();
...
<body>
	...
	<div class="buttom">
		<div style="position:relative;left:15px; top:10px;font-size:16px;margin:0 0 20px 0;">
			...
			style="color:blue;background:#CDC9C9;border-radius: 5px; ">全部订单</a> 
			<a href="AdminOrderGet.jsp?idAdmin=<%= idUser %>"  >待接收</a> 
			<a href="AdminOrderService.jsp?idAdmin=<%= idUser %>">服务中</a>
			...
			<div class="item">
				<a href="#">
					...
					<p
						...
						<span style="color:blue; float: left;"><%= s.getStatus() %></span>
						<span style="color: blue; font-size: 1.5em;float:right;padding-right: 5px;"><%=s.getPay()%>￥</span>
					</p></a>
			</div>
			<hr />
		</div>
